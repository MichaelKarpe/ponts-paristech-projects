...
#include "../lloyd_convergence/options.h"
...
struct qt_meta_stringdata_Dialog_options_t {
    QByteArrayData data[1];
    char stringdata0[15];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Dialog_options_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Dialog_options_t qt_meta_stringdata_Dialog_options = {
    {
QT_MOC_LITERAL(0, 0, 14) // "Dialog_options"
...
const QMetaObject Dialog_options::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Dialog_options.data,
      qt_meta_data_Dialog_options,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Dialog_options::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Dialog_options.stringdata0))
